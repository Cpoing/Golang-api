...
func (s *MySQLStorage) Init() (*sql.DB, error) {
  //Initialize tables
  if err := s.createProjecsTables(); err != nil {
    return nil, err
  }
  if err := s.createUsersTables(); err != nil {
    return nil, err
  }
  if err := s.createTasksTables(); err != nil {
    return nil, err
  }
...
func (s *MySQLStorage) createProjecsTables() error {
  _, err := s.db.Exec(`
...
func (s *MySQLStorage) createUsersTables() error {
  _, err := s.db.Exec(`
